            ...
            modelBuilder.Entity("Web_BanSach.Models.Book", b =>
                {
                    ...
                    b.Property<int>("AuthorMatacgia")
                        .HasColumnType("int");

                    b.Property<int>("GenreTheloaiId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AuthorMatacgia");

                    b.HasIndex("GenreTheloaiId");
            ...
            modelBuilder.Entity("Web_BanSach.Models.Book", b =>
                {
                    b.HasOne("Web_BanSach.Models.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorMatacgia")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Web_BanSach.Models.Genre", "Genre")
                        .WithMany("Books")
                        .HasForeignKey("GenreTheloaiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
